    ...
    >
      ...
      <Card title={"Icon"} style={{marginTop: 20}}>
        <View style={styles.demoButtonGroupContainer}>
          <RadioGroup
            style={styles.demoItem}
            items={[<Icon name={"staro"} size={20}/>, <Icon name={"staro"} size={20}/>, <Icon name={"staro"} size={20}/>]}
      ...
      <Card title={"Icon Title"} style={{marginTop: 20}}>
        <View style={styles.demoButtonGroupContainer}>
          <RadioGroup
            style={styles.demoItem}
            items={[<View style={{alignItems: 'center', flexDirection: 'row', color: 'inherit'}}>
              <Text style={{color: 'inherit'}}>One</Text>
              <Icon name={"staro"} size={20} style={{marginLeft: 5}}/>
            </View>, <View style={{alignItems: 'center', flexDirection: 'row', color: 'inherit'}}>
              <Text>Two</Text>
              <Icon name={"staro"} size={20} style={{marginLeft: 5}}/>
            </View>, <View style={{alignItems: 'center', flexDirection: 'row', color: 'inherit'}}>
              <Text>Three</Text>
