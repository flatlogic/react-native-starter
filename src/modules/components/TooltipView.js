      ...
      <Card title={'Default'}>
        <View>
          ...
          <Tooltip
            ...
            content={<Text style={{color: colors.white}}>Check this out!</Text>}
            placement="bottom"
            onClose={toggleModal}
            disableShadow
            backgroundColor={'transparent'}
            contentStyle={{ backgroundColor: '#676767' }}
          >
            <Button
              primary
              caption="toggle tooltip"
              onPress={toggleModal}
              style={{ flex: 1 }}
            />
          </Tooltip>
          ...
          <Tooltip
            ...
            content={
              <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                ...
                />
                <Text style={{color: colors.white}}>Check this out!</Text>
              </View>
            }
            placement="bottom"
            ...
            contentStyle={{ backgroundColor: '#676767' }}
          >
            <Button secondary caption="toggle tooltip" onPress={toggleModal2} />
          </Tooltip>
        </View>
      </Card>
      <Card title={'Backdrop'} style={{ marginTop: 20 }}>
        <View>
          ...
          <Tooltip
            ...
            disableShadow
            contentStyle={{ backgroundColor: '#5759CB'}}
          >
            <Button
              primary
              bordered
